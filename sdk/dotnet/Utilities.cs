...
namespace Pulumi.Inwx
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/wombelix/pulumi-inwx/releases";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Inwx.version.txt");
    ...
    internal sealed class InwxResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public InwxResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
