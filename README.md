...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `inwx` with the `NAME` of your provider.
...
- binary: pulumi-resource-inwx
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-inwx/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-inwx/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-inwx_darwin_amd64_v1
│   └── pulumi-resource-inwx
├── pulumi-inwx_darwin_arm64
│   └── pulumi-resource-inwx
├── pulumi-inwx_linux_amd64_v1
│   └── pulumi-resource-inwx
├── pulumi-inwx_linux_arm64
│   └── pulumi-resource-inwx
├── pulumi-inwx_windows_amd64_v1
│   └── pulumi-resource-inwx.exe
└── pulumi-inwx_windows_arm64
    └── pulumi-resource-inwx.exe
```
